...
TK_LIBS='-L/usr/X11R6/lib64 -lX11 -lXss -lXext -L/usr/X11R6/lib64 -lXft -lX11 -lfreetype -lfontconfig -L/usr/X11R6/lib64 -lXrender  -ldl  -lieee -lm'

# Top-level directory in which Tk's platform-independent files are
# installed.
TK_PREFIX='/users/jxu1/tcltk_x64_install'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/users/jxu1/tcltk_x64_install'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/users/jxu1/tk8.5.9/unix -ltk8.5'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/users/jxu1/tcltk_x64_install/lib -ltk8.5'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/users/jxu1/tcltk_x64_install/include'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/users/jxu1/tk8.5.9/unix -ltkstub8.5'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/users/jxu1/tcltk_x64_install/lib -ltkstub8.5'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/users/jxu1/tk8.5.9/unix/libtkstub8.5.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/users/jxu1/tcltk_x64_install/lib/libtkstub8.5.a'
