...
#_EXECPATH_ -w -bus_exp 7 -bb -arch _arch -type bram -wp 10 -rp 0011 -data_width pmi_wr_data_width -num_rows pmi_wr_addr_depth -rdata_width pmi_rd_data_width _regmode -gsr _gsr _resetmode _memfile -memformat _memformat -cascade _cascade -byte pmi_byte_size -n _module_name -pmi
