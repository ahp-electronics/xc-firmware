...
#_EXECPATH_ -w -bus_exp 7 -bb -arch _arch -type sspram -num_rows pmi_addr_depth -data_width pmi_data_width _regmode _memfile -memformat _memformat -n _module_name -pmi
