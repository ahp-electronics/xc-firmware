...
#ifndef pmi_add_sub0
#define pmi_add_sub0 add
#endif

#if #pmi_add_sub0 == "add"
#define _add_sub0 -madd0
#else
#define _add_sub0 -msub0
#endif

#ifndef pmi_add_sub1
#define pmi_add_sub1 add
#endif

#if #pmi_add_sub1 == "add"
#define _add_sub1 -madd1
#else
#define _add_sub1 -msub1
#endif
...
#define _pfu_mult_add_sum
#else
#define _pfu_mult_add_sum -pfu_mult -pfu_add -pfu_sum
#endif

#define _EXECPATH_ FOUNDRY##/bin/##PLATFORM##/scuba
#define _arch PM

#_EXECPATH_ -w -n _module_name _pfu_mult_add_sum -widtha pmi_dataa_width -widthb pmi_datab_width _signed _pipeline _input_reg _output_reg _add_sub0 _add_sub1 -bus_exp 7 -bb -arch _arch -type dspmaddsum -gsr ENABLED -area -clk0 -ce0 -rst0 -simple_portname
