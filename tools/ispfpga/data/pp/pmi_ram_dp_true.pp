...
#_EXECPATH_ -w -bus_exp 7 -bb -arch _arch -type bram -wp 11 -rp 1010 -data_width pmi_data_width_a -rdata_width pmi_data_width_b -num_rows pmi_addr_depth_a _regmode_a _regmode_b -gsr _gsr -write_mode_0 _writemodeA -write_mode_1 _writemodeB _resetmode _memfile -memformat _memformat -cascade _cascade -n _module_name -pmi
