...
#_EXECPATH_ -w -bus_exp 7 -bb -arch _arch -type bram -wp 10 -rp 1000 -data_width pmi_data_width -num_rows pmi_addr_depth _regmode -gsr _gsr -write_mode_0 _writemode _resetmode _memfile -memformat _memformat -cascade _cascade -n _module_name -pmi
