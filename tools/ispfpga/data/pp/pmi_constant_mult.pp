...
#define _pfu_mult
#elif #pmi_implementation == "LUT"
#define _pfu_mult -pfu_mult
#elif #pmi_implementation == "Auto"
#define _pfu_mult -pfu_mult -ram_mult 3
#elif #pmi_implementation == "EBR"
#define _pfu_mult -pfu_mult -ram_mult 2
#else
#define _pfu_mult -pfu_mult -ram_mult 1
#endif

#define _EXECPATH_ FOUNDRY##/bin/##PLATFORM##/scuba
#define _arch PM

#_EXECPATH_ -w -n _module_name _pfu_mult -widtha pmi_dataa_width -widthb pmi_datab_width -value pmi_constant_value _signed _pipeline _input_reg _output_reg -bus_exp 7 -bb -arch _arch -type dspmult -gsr ENABLED -area -clk0 -ce0 -rst0 -simple_portname
