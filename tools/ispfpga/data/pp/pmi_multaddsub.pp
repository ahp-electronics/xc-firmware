...
#if #pmi_add_sub == "add"
#define _add_sub -madd
#else
#define _add_sub -msub
#endif
...
#define _pfu_mult_add
#else
#define _pfu_mult_add -pfu_mult -pfu_add
#endif

#define _EXECPATH_ FOUNDRY##/bin/##PLATFORM##/scuba
#define _arch PM

#_EXECPATH_ -w -n _module_name _pfu_mult_add -widtha pmi_dataa_width -widthb pmi_datab_width _signed _pipeline _input_reg _output_reg _add_sub -bus_exp 7 -bb -arch _arch -type dspmadd -gsr ENABLED -area -clk0 -ce0 -rst0 -simple_portname
