...
*/
// fpga\verilog\pkg\versclibs\data\pmi\pmi_pll.v 1.16 20-FEB-2014 15:16:38 FGAO2
...
module pmi_pll
 #(parameter pmi_freq_clki = 100,
   ...
   parameter pmi_freq_clkok = 50,   // EC/XP/ECP/XO/ECP2/XP2/ECP3 only
   parameter pmi_family = "EC",
   parameter pmi_phase_adj = 0,   // in degrees, ex: 45, 90 etc.
   parameter pmi_duty_cycle = 50, // in percentage; EC/XP/ECP/XO/ECP2/XP2/ECP3 only
