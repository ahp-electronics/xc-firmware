...
pmi_family  "EC"|"XP"|"XP2"|"SC"|"SCM"|"ECP"|"ECP2"|"ECP2M"|"ECP3"|"XO"|"XO2"|"LPTM"|"ECP5U"|  "EC"
...
*/
// fpga\verilog\pkg\versclibs\data\pmi\pmi_fifo_dc.v 1.28 20-FEB-2014 15:16:01 FGAO2
...
// Error Checks
   initial begin
	...
	begin
      ...
      if ( ( ((pmi_family != "ECP5U") && (pmi_family != "ECP5UM") &&
              (pmi_family != "SC") && (pmi_family != "SCM") &&
