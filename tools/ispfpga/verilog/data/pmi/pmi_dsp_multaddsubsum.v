...
------------------------------------------------------------------------------
  ...
  pmi_family          "ECP"|"ECP2"|"ECP2M"|"XP2"|"ECP3"|"ECP5U"          "ECP2"
...
------------------------------------------------------------------------------
*/
// fpga\verilog\pkg\versclibs\data\pmi\pmi_dsp_multaddsubsum.v 1.23 20-FEB-2014 15:15:39 FGAO2
//
...
initial
   if (pmi_pipelined_mode == "on" && pmi_family != "ECP3" && pmi_family != "ECP5U" && pmi_family != "ECP5UM")
   begin
