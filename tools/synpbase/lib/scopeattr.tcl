...
set altera_retiming "stratix* flex* acex* apex* mercury* excalibur* arria*"
set apex "apex20k apexii excalibur*"
set apexe "apex20kc apex20ke mercury* stratix* cyclone* arria*"
set apex20k "apex20k*"
set lattice "pLSI*"
...
set xilinx "xc* vir* spart* artix* kintex*"
set xilinx_cplds "coolrunner* xc9500*"
set virtex "vir* spartan* artix* kintex*"
set virtex2 "virtex2*"
set phys "vir* spartan3"
set stratix "stratix* arria*"
set triscend "triscend*" 
set asic "asic*" 
set atmel "AT40K* atfpslic" 
set cp_only "apex20k* excalibur* mercury apexii stratix* cyclone* spartan* virtex* Lattice-ECP* ECP5*" 
...
add_scope_attr {syn_resources} "$xilinx apexii mercury* stratix* cyclone*" {module} {string} {} {Resources used inside a black box} {0} {} {} {0}
add_scope_attr {syn_srlstyle} "$virtex $virtex2 stratix* cyclone* $lattice_srl $achronix $actel_srl $gowin" {cell} {string} {registers} {Inferred SRL implementation style} {0} "Virtex virtex-E spartan2 spartan2e spartan3e spartan3 spartan3a virtex2 virtex2p virtex4 virtex5 virtex6 virtex7 aritx7 kintex7 (select_srl registers noextractff_srl) $lattice_srl_new (registers distributed block_ram)  $achronix_srl (registers logic_ram) stratixIII stratixIV stratixV (altshift_tap registers block_ram MLAB)stratix stratixII stratixII-GX stratix-GX cyclone* (altshift_tap registers block_ram) $actel_srl (registers uram) $gowin (registers block_ram distributed_ram)" {} {0}
add_scope_attr {syn_srlstyle} "$virtex $virtex2 stratix* cyclone* $lattice_srl $achronix $actel_srl $gowin" {global} {string} {registers} {Inferred SRL implementation style} {0} "Virtex virtex-E spartan2 spartan2e spartan3e spartan3 spartan3a virtex2 virtex2p virtex4 virtex5 virtex6 virtex7 aritx7 kintex7 (select_srl registers noextractff_srl) $lattice_srl_new (registers distributed block_ram)  $achronix_srl (registers logic_ram) stratixIII stratixIV stratixV (altshift_tap registers block_ram MLAB)stratix stratixII stratixII-GX stratix-GX cyclone* (altshift_tap registers block_ram) $actel_srl (registers uram) $gowin (registers block_ram distributed_ram)" {} {0}
add_scope_attr {syn_srlstyle} "$virtex $virtex2 stratix* cyclone* $lattice_srl $achronix $actel_srl $gowin" {module} {string} {registers} {Inferred SRL implementation style} {0} "Virtex virtex-E spartan2 spartan2e spartan3e spartan3 spartan3a virtex2 virtex2p virtex4 virtex5 virtex6 virtex7 aritx7 kintex7 (select_srl registers noextractff_srl) $lattice_srl_new (registers distributed block_ram)  $achronix_srl (registers logic_ram) stratixIII stratixIV stratixV (altshift_tap registers block_ram MLAB)stratix stratixII stratixII-GX stratix-GX cyclone* (altshift_tap registers block_ram) $actel_srl (registers uram) $gowin (registers block_ram distributed_ram)" {} {0}
add_scope_attr {syn_ramstyle} "$achronix $pango $atmel $altera $apex $apexe $xilinx $lattice1 $lucent $quicklogic $actel_ram $siliconblue $gowin" {cell} {string} {registers} {Inferred RAM implementation style} {0} "Virtex virtex-E spartan2 spartan2e spartan3e spartan3 spartan3a virtex2 virtex2p virtex4 (registers block_ram no_rw_check rw_check area select_ram tmr) virtex5 virtex6 aritx7 kintex7 virtex7 (registers block_ram no_rw_check rw_check area select_ram ecc tmr) xilinx_default (registers select_ram) $achronix_srl (registers logic_ram block_ram no_rw_check rw_check) Axcelerator 500K PA ProASIC3 ProASIC3E (registers block_ram no_rw_check rw_check) IGLOO2 SmartFusion2 (registers lsram uram no_rw_check rw_check lsram,rw_check lsram,no_rw_check uram,rw_check uram,no_rw_check) RTG4 (registers lsram uram no_rw_check rw_check lsram,rw_check lsram,no_rw_check uram,rw_check uram,no_rw_check ecc ecc,set uram,ecc lsram,ecc uram,ecc,set lsram,ecc,set) $lattice1 Lattice-EC $lattice1 Lattice-ECP Lattice-ECP2 $lattice1 Lattice-SC $lattice1 Lattice-XP $lattice1 Lattice-MachXO(registers distributed block_ram) $siliconblue SBTiCE65 $siliconblue SBTiCE40(registers block_ram no_rw_check rw_check area) $siliconblue SBTiCE5(registers block_ram no_rw_check rw_check area) $gowin (registers block_ram no_rw_check rw_check distributed_ram) stratix stratixII stratixII-GX stratix-GX(registers block_ram block_ram,no_rw_check M512 M512,no_rw_check M4K M4K,no_rw_check M-RAM M-RAM,no_rw_check, rw_check M512 M512, rw_check M4K M4K, rw_check M-RAM M-RAM, rw_check) cycloneIII stratixIII stratixIV (tmr registers MLAB block_ram block_ram,no_rw_check M9K M9K,no_rw_check M144K M144K,no_rw_check,rw_check M9K M9K,rw_check M144K M144K,rw_check) stratixV(registers MLAB block_ram block_ram,no_rw_check M20K M20K,no_rw_check,rw_check M20K M20K,rw_check,ecc tmr) altera_default (registers block_ram tmr) default (registers) all_enums (registers block_ram no_rw_check rw_check select_ram)" {} {0}
add_scope_attr {syn_ramstyle} "$achronix $pango $atmel $altera $apex $apexe $xilinx $lattice1 $lucent $quicklogic $actel_ram $siliconblue $gowin" {global} {string} {registers} {Inferred RAM implementation style} {0} "Virtex virtex-E spartan2 spartan2e spartan3e spartan3 spartan3a virtex2 virtex2p virtex4 (registers block_ram no_rw_check rw_check area select_ram tmr) virtex5 virtex6 aritx7 kintex7 virtex7 (registers block_ram no_rw_check rw_check area select_ram ecc tmr) xilinx_default (registers select_ram) $achronix_srl (registers logic_ram block_ram no_rw_check rw_check) Axcelerator 500K PA ProASIC3 ProASIC3E (registers block_ram no_rw_check rw_check) IGLOO2 SmartFusion2 (registers lsram uram no_rw_check rw_check lsram,rw_check lsram,no_rw_check uram,rw_check uram,no_rw_check) RTG4 (registers lsram uram no_rw_check rw_check lsram,rw_check lsram,no_rw_check uram,rw_check uram,no_rw_check ecc ecc,set uram,ecc lsram,ecc uram,ecc,set lsram,ecc,set) $lattice1 Lattice-EC $lattice1 Lattice-ECP Lattice-ECP2 $lattice1 Lattice-SC $lattice1 Lattice-XP $lattice1 Lattice-MachXO(registers distributed block_ram) $siliconblue SBTiCE65 $siliconblue SBTiCE40(registers block_ram no_rw_check rw_check area) $siliconblue SBTiCE5(registers block_ram no_rw_check rw_check area) $gowin (registers block_ram no_rw_check rw_check distributed_ram) stratix stratixII stratixII-GX stratix-GX(registers block_ram block_ram,no_rw_check M512 M512,no_rw_check M4K M4K,no_rw_check M-RAM M-RAM,no_rw_check, rw_check M512 M512, rw_check M4K M4K, rw_check M-RAM M-RAM, rw_check) cycloneIII stratixIII stratixIV (tmr registers MLAB block_ram block_ram,no_rw_check M9K M9K,no_rw_check M144K M144K,no_rw_check,rw_check M9K M9K,rw_check M144K M144K,rw_check) stratixV(registers MLAB block_ram block_ram,no_rw_check M20K M20K,no_rw_check,rw_check M20K M20K,rw_check,ecc tmr) altera_default (registers block_ram tmr) default (registers) all_enums (registers block_ram no_rw_check rw_check select_ram)" {} {0}
add_scope_attr {syn_ramstyle} "$achronix $pango $atmel $altera $apex $apexe $xilinx $lattice1 $lucent $quicklogic $actel_ram $siliconblue $gowin" {module} {string} {registers} {Inferred RAM implementation style} {0} "Virtex virtex-E spartan2 spartan2e spartan3e spartan3 spartan3a virtex2 virtex2p virtex4 (registers block_ram no_rw_check rw_check area select_ram tmr) virtex5 virtex6 aritx7 kintex7 virtex7 (registers block_ram no_rw_check rw_check area select_ram ecc tmr) xilinx_default (registers select_ram) $achronix_srl (registers logic_ram block_ram no_rw_check rw_check) Axcelerator 500K PA ProASIC3 ProASIC3E (registers block_ram no_rw_check rw_check) IGLOO2 SmartFusion2 (registers lsram uram no_rw_check rw_check lsram,rw_check lsram,no_rw_check uram,rw_check uram,no_rw_check) RTG4 (registers lsram uram no_rw_check rw_check lsram,rw_check lsram,no_rw_check uram,rw_check uram,no_rw_check ecc ecc,set uram,ecc lsram,ecc uram,ecc,set lsram,ecc,set) $lattice1 Lattice-EC $lattice1 Lattice-ECP Lattice-ECP2 $lattice1 Lattice-SC $lattice1 Lattice-XP $lattice1 Lattice-MachXO(registers distributed block_ram) $siliconblue SBTiCE65 $siliconblue SBTiCE40(registers block_ram no_rw_check rw_check area) $siliconblue SBTiCE5(registers block_ram no_rw_check rw_check area) $gowin (registers block_ram no_rw_check rw_check distributed_ram) stratix stratixII stratixII-GX stratix-GX(registers block_ram block_ram,no_rw_check M512 M512,no_rw_check M4K M4K,no_rw_check M-RAM M-RAM,no_rw_check, rw_check M512 M512, rw_check M4K M4K, rw_check M-RAM M-RAM, rw_check) cycloneIII stratixIII stratixIV (tmr registers MLAB block_ram block_ram,no_rw_check M9K M9K,no_rw_check M144K M144K,no_rw_check,rw_check M9K M9K,rw_check M144K M144K,rw_check) stratixV(registers MLAB block_ram block_ram,no_rw_check M20K M20K,no_rw_check,rw_check M20K M20K,rw_check,ecc tmr) altera_default (registers block_ram tmr) default (registers) all_enums (registers block_ram no_rw_check rw_check select_ram)" {} {0}
...
add_scope_attr {syn_multstyle} "$virtex $virtex2 $pango $altera $apex $apexe $apex20k $lucent $lattice $mach excalibur* spartan3 Axcelerator IGLOO2 RTG4 SmartFusion2 arriaV arria10 stratix10 cycloneV SBTiCE40UP" {cell} {string} {block_mult} {Inferred multiplier implementation style} {0} "Virtex virtex-E spartan2 spartan2e spartan3 spartan3e virtex2 virtex2p virtex4 virtex5(logic block_mult)arriaV cycloneV arria10 stratix10 (logic lpm_mult altmult_add block_mult simd) stratix(logic lpm_mult altmult_add block_mult) altera_default (logic lpm_mult altmult_add block_mult) Axcelerator IGLOO2 RTG4 SmartFusion2 (logic DSP) actel_default (logic DSP) $lattice_srl_new (block_mult logic) all_enums (logic block_mult lpm_mult simd) SBTiCE40UP (DSP logic)" {} {0}
add_scope_attr {syn_multstyle} "$virtex $virtex2 $pango $altera $apex $apexe $apex20k $lucent $lattice $mach excalibur* spartan3 Axcelerator IGLOO2 RTG4 SmartFusion2 arriaV arria10 stratix10 cycloneV SBTiCE40UP" {global} {string} {block_mult} {Inferred multiplier implementation style} {0} "Virtex virtex-E spartan2 spartan2e spartan3 spartan3e virtex2 virtex2p virtex4 virtex5(logic block_mult)arriaV cycloneV arria10 stratix10 (logic lpm_mult altmult_add block_mult simd) stratix(logic lpm_mult altmult_add block_mult) altera_default (logic lpm_mult altmult_add block_mult) Axcelerator IGLOO2 RTG4 SmartFusion2 (logic DSP) actel_default (logic DSP) $lattice_srl_new (block_mult logic) all_enums (logic block_mult lpm_mult simd) SBTiCE40UP (DSP logic)" {} {0}
add_scope_attr {syn_multstyle} "$virtex $virtex2 $pango $altera $apex $apexe $apex20k $lucent $lattice $mach excalibur* spartan3 Axcelerator IGLOO2 RTG4 SmartFusion2 arriaV arria10 stratix10 cycloneV SBTiCE40UP" {module} {string} {block_mult} {Inferred multiplier implementation style} {0} "Virtex virtex-E spartan2 spartan2e spartan3 spartan3e virtex2 virtex2p virtex4 virtex5(logic block_mult)arriaV cycloneV arria10 stratix10 (logic lpm_mult altmult_add block_mult simd) stratix(logic lpm_mult altmult_add block_mult) altera_default (logic lpm_mult altmult_add block_mult) Axcelerator IGLOO2 RTG4 SmartFusion2 (logic DSP) actel_default (logic DSP) $lattice_srl_new (block_mult logic) all_enums (logic block_mult lpm_mult simd) SBTiCE40UP (DSP logic)" {} {0}
...
add_scope_attr {altera_io_opendrain} {apex20kc apex20ke excalibur* mercury* cyclone* stratix* acex* flex10k* } {port} {boolean} {} {Use opendrain capability on port or bit-port.} {0} {} {} {0}
...
add_scope_attr {syn_dspstyle} "virtex4 virtex5 virtex6 virtex7 $siliconblue $gowin" {cell} {string} {dsp48} {Inferred DSP implementation style} {0} "virtex4(logic dsp48) virtex5 virtex6 virtex7(logic dsp48 simd) $siliconblue SBTiCE40(logic dsp) $gowin GoWin(logic dsp) $siliconblue SBTiCE5(logic dsp) all_enums (logic dsp48)" {} {0}
add_scope_attr {syn_dspstyle} "virtex4 virtex5 virtex6 virtex7 $siliconblue $gowin" {module} {string} {dsp48} {Inferred DSP implementation style} {0} "virtex4(logic dsp48) virtex5 virtex6 virtex7(logic dsp48 simd) $siliconblue SBTiCE40(logic dsp) $gowin GoWin(logic dsp) $siliconblue SBTiCE5(logic dsp) all_enums (logic dsp48)" {} {0}
add_scope_attr {syn_dspstyle} "virtex4 virtex5 virtex6 virtex7 $siliconblue $gowin" {global} {string} {dsp48} {Inferred DSP implementation style} {0} "virtex4(logic dsp48) virtex5 virtex6 virtex7(logic dsp48 simd) $siliconblue SBTiCE40(logic dsp) $gowin GoWin(logic dsp) $siliconblue SBTiCE5(logic dsp) all_enums (logic dsp48)" {} {0}
