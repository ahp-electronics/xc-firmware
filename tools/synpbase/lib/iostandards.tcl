...
# $Header: //synplicity/ui2018q2p1/misc/iostandards.tcl#1 $
...
add_io_standard {DIFF_SSTL_15} "$stratixv $arriav $virtex6 $virtex7 $max10 arria10 stratix10 arriavgz $cyclone10gx" {2} {Differential 1.5-V SSTL}
...
add_io_standard {SSTL_15} "$stratixv $arriav $cyclonev $virtex6 $virtex7 $max10 arria10 stratix10 arriavgz $cyclone10gx" {2} {SSTL-15}
...
add_io_standard {LVCMOS_12} "$arriaii $stratixiii $stratixiv $stratixv $arriav $cyclonev $cycloneiii $cycloneiv $max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {1} {1.2 V}
add_io_standard {HSTL_12_I} "$arriaiigz $arriagx $arriaii $stratixiii $stratixiv $stratixv $arriav $cyclonev $cycloneiii $cycloneiv $max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {1.2-V HSTL Class I}
add_io_standard {HSTL_12_II} "$arriaiigz $arriaii $stratixiii $stratixiv $stratixv $arriav $cyclonev $cycloneiii $cycloneiv $max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {1.2-V HSTL Class II}
add_io_standard {LVCMOS_15} "$arriaii $stratixiii $stratixiv $stratixv $arriav $cyclonev $cycloneiii $cycloneiv $max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {1.5 V}
add_io_standard {LVCMOS_18} "$arriaii $stratixiii $stratixiv $stratixv $arriav $cyclonev $cycloneiii $cycloneiv $max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {1.8 V}
...
add_io_standard {LVCMOS} "$arriaii $stratixiii $cycloneiii $cycloneiv $arriav $max10 arria10 stratix10 $cyclone10lp $cyclone10gx" {2} {3.0-V LVCMOS}
add_io_standard {LVTTL} "$arriaii $stratixiii $cycloneiii $cycloneiv $arriav $cyclonev $max10 arria10 stratix10 $cyclone10lp $cyclone10gx" {2} {3.0-V LVTTL}
...
add_io_standard {DIFF_HSTL_12_I} "$arriaiigz $arriaii $stratixiii $stratixiv $stratixv $arriav $cyclonev $cycloneiii $cycloneiv $max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {Differential 1.2-V HSTL Class I}
add_io_standard {DIFF_HSTL_12_II} "$arriaiigz $arriaii $stratixiii $stratixiv $stratixv $arriav $cyclonev $cycloneiii $cycloneiv $max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {Differential 1.2-V HSTL Class II}
add_io_standard {DIFF_SSTL_15_I} "$arriaiigz $arriaii $stratixiii $stratixiv $stratixv $arriav $cyclonev $max10 arria10 stratix10 arriavgz $cyclone10gx" {2} {Differential 1.5-V SSTL Class I}
add_io_standard {DIFF_SSTL_15_II} "$arriaiigz $stratixiii $stratixiv $stratixv $arriav $max10 arria10 stratix10 arriavgz $cyclone10gx" {2} {Differential 1.5-V SSTL Class II}
...
add_io_standard {SSTL_15_I} "$arriaiigz $arriaii $stratixiii $stratixiv $stratixv $arriav $cyclonev $max10 arria10 stratix10 arriavgz $cyclone10gx" {2} {SSTL-15 Class I}
add_io_standard {SSTL_15_II} "$arriaiigz $stratixiii $stratixiv $stratixv $arriav $cyclonev $max10 arria10 stratix10 arriavgz $cyclone10gx" {2} {SSTL-15 Class II}
...
add_io_standard {HCSL} "$arriagx $arriaii $stratixiv $stratixv $arriav $cyclonev arria10 stratix10 arriavgz $cyclone10gx" {2} {HCSL}
...
add_io_standard {LVTTL_33} "$arriaiigz $arriagx $arriaii $stratixiv $stratixv $arriav $cyclonev $cycloneiii $cycloneiv $max10 arria10 stratix10 arriavgz $cyclone10lp" {2} {3.3-V LVTTL}
...
add_io_standard {HSUL_12} "$stratixv $arriav $cyclonev $max10 arria10 stratix10 arriavgz $cyclone10gx" {2} {1.2-V HSUL}
add_io_standard {DIFF_HSUL_12} "$stratixv $arriav $cyclonev $max10 arria10 stratix10 arriavgz $cyclone10gx" {2} {Differential 1.2-V HSUL}
...
add_io_standard {SSTL_125} "$stratixv $arriav $cyclonev arria10 stratix10 arriavgz $cyclone10gx" {2} {SSTL-125}
add_io_standard {SSTL_125_I} "arria10 stratix10i $cyclone10gx" {2} {SSTL-125 Class I}
add_io_standard {SSTL_125_II} "arria10 stratix10 $cyclone10gx" {2} {SSTL-125 Class II}
...
add_io_standard {SSTL_12} "$stratixv arria10 stratix10 arriavgz $cyclone10gx" {2} {SSTL-12}
add_io_standard {SSTL_12_I} "arria10 stratix10 $cyclone10gx" {2} {SSTL-12 Class I}
add_io_standard {SSTL_12_II} "arria10 stratix10 $cyclone10gx" {2} {SSTL-12 Class II}
...
add_io_standard {SSTL_135} "$stratixv $arriav $cyclonev $max10 arria10 stratix10 arriavgz $cyclone10gx" {2} {SSTL-135}
add_io_standard {SSTL_135_I} "arria10 stratix10 $cyclone10gx" {2} {SSTL-135 Class I}
add_io_standard {SSTL_135_II} "arria10 stratix10 $cyclone10gx" {2} {SSTL-135 Class II}
...
add_io_standard {RSDS} "$max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {RSDS}
add_io_standard {LVDS} "$max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {LVDS}
add_io_standard {Differential_18_V_SSTL_Class_II} "$max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {Differential 1.8-V SSTL Class II}
add_io_standard {Differential_LVPECL} "$max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {Differential LVPECL}
add_io_standard {15_V_HSTL_Class_I} "$max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {1.5-V HSTL Class I}
add_io_standard {18_V_HSTL_Class_II} "$max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {1.8-V HSTL Class II}
...
add_io_standard {Differential_18_V_HSTL_Class_II} "$max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {Differential 1.8-V HSTL Class II}
add_io_standard {Differential_18_V_HSTL_Class_I} "$max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {Differential 1.8-V HSTL Class I}
add_io_standard {Differential_15_V_HSTL_Class_I} "$max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {Differential 1.5-V HSTL Class I}
add_io_standard {SSTL_2_Class_II} "$max10 arriavgz $cyclone10lp" {2} {SSTL-2 Class II}
add_io_standard {15_V_HSTL_Class_II} "$max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {1.5-V HSTL Class II}
add_io_standard {18_V_HSTL_Class_I} "$max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {1.8-V HSTL Class I}
...
add_io_standard {mini_LVDS} "$max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {mini-LVDS}
add_io_standard {SSTL_18_Class_II} "$max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {SSTL-18 Class II}
add_io_standard {Differential_15_V_HSTL_Class_II} "$max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {Differential 1.5-V HSTL Class II}
add_io_standard {SSTL_18_Class_I} "$max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {SSTL-18 Class I}
...
add_io_standard {Differential_18_V_SSTL_Class_I} "$max10 arria10 stratix10 arriavgz $cyclone10lp $cyclone10gx" {2} {Differential 1.8-V SSTL Class I}
add_io_standard {33_V_LVCMOS} "$max10 arria10 stratix10 arriavgz $cyclone10lp" {2} {3.3-V LVCMOS}
...
add_io_standard {Differential_12_V_POD} "arria10 stratix10 $cyclone10gx" {2} {Differential 1.2-V POD}
add_io_standard {Current_Mode_Logic_(CML)} "arria10 stratix10" {2} {Current Mode Logic (CML)}
add_io_standard {12_V_POD} "arria10 stratix10 $cyclone10gx" {2} {1.2-V POD}
add_io_standard {High_Speed_Differential_I/O} "arria10 stratix10 $cyclone10gx" {2} {High Speed Differential I/O}
